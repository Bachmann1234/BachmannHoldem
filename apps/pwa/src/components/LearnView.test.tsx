...
/**
 * LearnView test (the rules entry): the Learn screen offers a standalone "start with the rules" card
 * that opens the {@link RulesOverlay} reference, distinct from opening a graded lesson node. Other
 * LearnView behaviour (the medallion path, progress) is exercised via App.nav.test.tsx.
 */
